function [squared_error,rnmse_seq] = online_mhkernel_eval(A_T,x_T,y_T,a_T,sigma,D,H,step,mu,theta_i,A_0,x_0,a_0,y_0)
%% Inputs
...
%% Predict
x_pred=(1/H)*trace(theta'*Z);% prediction for this specific item
%% Error
