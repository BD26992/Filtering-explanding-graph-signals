function [squared_error2,rnmse_seq,h,A_latest,x_latest,a_latest,H] = onlinepc(A_T,x_T,a_T,L,step,mu,nlinks,h_i,scale)
...
%% Update filter
   ...
   squared_error2(i)=(x_pred(i)-x_true(i))^2+mu*norm(h)^2;
%       if norm(h)>=10000
%           h=10000*h/norm(h);
%       end
if mod(i,10)==0
