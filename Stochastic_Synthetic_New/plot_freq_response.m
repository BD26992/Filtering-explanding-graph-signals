...
switch plottype
    ...
    case 'single'
        ...
        plot(gridplot,H_det(:,end),'linewidth',2);
        plot(gridplot,H_psto(:,end),'linewidth',2);
        plot(gridplot,freq_sto(:,end)','linewidth',2);
        plot(gridplot,freq_ada(:,end)','linewidth',2);
        plot(gridplot,freq_batch','linewidth',2);
        %plot(gridplot,freq_ada2(:,end)');
        xlabel('Frequency');ylabel('Response');title('Filter Data');
