function [squared_error,rnmse_seq,h] = online_ada2_eval(A_T,x_T,a_T,D_T,L,step,mu,nlinks,h_i,A_0,x_0,a_0,P,eta_p,p_i,D_i,scale)
%% Description
...
%% Update A_ex
A_ex=A_T{i};x_ex=x_T{i};att = a_T{i};D=D_T{i};
