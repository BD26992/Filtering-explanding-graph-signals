function [squared_error2,rnmse_seq,theta,A_latest,x_latest,a_latest] = online_kernel(A_T,x_T,a_T,sigma,D,step,mu,hki)
%% Inputs
...
squared_error2(i)=squared_error(i)+mu*norm(theta)^2;
%% Update filter
